#
#THIS CODE CREATES THE FINAL EXCEL FILE WITH PREDICTIONS AND REAL RESULTS FROM 2023 2024 SEASON
#IT ALSO ADDS THE WIN AND WIN PERCENTAGE DIFFERENCES FOR EASIER ANALYSIS
#
import pandas as pd
...
modelPrediciton.to_excel("final_results.xlsx",index=False)
